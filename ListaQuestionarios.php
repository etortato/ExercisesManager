...
<head>
    <meta charset="UTF-8">
    <title>Cadastro de Questionários</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li>
                    <a class="btn btn-toolbar" href="./ListaQuestoes.php">Questões</a>
                </li>
                <li>
                    <a class="btn btn-toolbar btn-selected" href="#">Questionários</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-12">
                <p>
                <div class="form-group">
                    <label class="text-right" for="txtQuestionario">
                        Questionário:
                    </label>
                    <input type="text" class="form-control" title="Filtre pelo nome do questionário."
                           placeholder="Filtro pelo nome do questionário" name="txtQuestionario" id="txtQuestionario">
                </div>
                </p>
            </div>
...
<input type="hidden" id="hdnListaQuestionario" value="1">
<?php
